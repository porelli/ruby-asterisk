...
module RubyAsterisk
  ...
  class AMI
    ...
    def originate(caller, context, callee, priority, variable = nil, timeout)
      execute 'Originate', {'Channel' => caller, 'Context' => context, 'Exten' => callee, 'Priority' => priority, 'Callerid' => caller, 'Timeout' => timeout, 'Variable' => variable  }
    end
    ...
    def redirect(caller,context,callee,priority,variable=nil, timeout)
      execute 'Redirect', {'Channel' => caller, 'Context' => context, 'Exten' => callee, 'Priority' => priority, 'Callerid' => caller, 'Timeout' => timeout, 'Variable' => variable}
    end
